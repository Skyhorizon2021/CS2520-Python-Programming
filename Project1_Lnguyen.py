#Name: Loc Nguyen
#Project 1 Task 1
#Objective - Calculate BMI in Metric and Imperial System. Allow user to select which system, enter the weight and height
import math
import re

#User select which system 
systemChoice = int(input("To calculate your BMI, select 1 for Imperial System or 2 for Metric System: "))

if systemChoice == 1:
    weight = float(input("Enter your weight using pounds: "))
    if weight <= 0: #only positive number
        print("Invalid weight")
        exit()
    height = float(input("Enter your height using inches: "))
    if height <= 0: #only positive number
        print("Invalid height")
        exit()
    bodyMassIndex = (703*(weight/(height**2)))
    print("Your BMI is %.2f" % bodyMassIndex)
elif systemChoice == 2:
    weight = float(input("Enter your weight using kilograms: "))
    if weight <= 0: #only positive number
        print("Invalid weight")
        exit()
    height = float(input("Enter your height using meters: "))
    if height <= 0: #only positive number
        print("Invalid height")
        exit()
...
'''Output
Test(1)
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 1
Enter your weight using pounds: 155
Enter your height using inches: 70
Your BMI is 22.24
Test(2)
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 1
Enter your weight using pounds: 172
Enter your height using inches: 68
Your BMI is 26.15
Test(3)
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 2
Enter your weight using kilograms: 75
Enter your height using meters: 1.83
Your BMI is 24.82
Test(4)
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 2
Enter your weight using kilograms: 51.5
Enter your height using meters: 1.68
Your BMI is 21.54
Test(5) Imperial Normal Input
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 1
Enter your weight using pounds: 100
Enter your height using inches: 72
Your BMI is 13.56
Test(6) Imperial Abnormal Input
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 1
Enter your weight using pounds: 150
Enter your height using inches: -8
Invalid height
Test(7) Metric Normal Input
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 2
Enter your weight using kilograms: 70
Enter your height using meters: 1.9
Your BMI is 20.68
Test(8) Metric Abnormal Input
To calculate your BMI, select 1 for Imperial System or 2 for Metric System: 2
Enter your weight using kilograms: 0
Invalid weight
'''

#Project 1 task 2
#Objective - Calculate sin(x) using Taylor's formula
